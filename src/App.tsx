    ...
    <>
      ...
      <div className="flex flex-col h-screen items-center justify-center m-auto max-w-[40%]">
        <div className="big-shadow bg-white flex flex-col gap-4 items-center justify-center max-w-full min-w-[300px] px-2 py-4 relative rounded-sm">
          ...
          <FileUploadForm
            className="relative flex justify-center align-center font-bold py-2 cursor-pointer text-center rounded-full shadow-md bg-red-200 hover:bg-red-300"
          ...
          {fileData.map((fileObj) => (
            <ClipboardButton
              ...
              className="bg-red-200 cursor-copy flex 
              gap-1 hover:bg-red-300 items-center no-scrollbar 
